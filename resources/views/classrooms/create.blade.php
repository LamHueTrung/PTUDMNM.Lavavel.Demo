                        ...
                        <div class="card-body">
                            <form action="{{ route('classrooms.store') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="IdClass" placeholder="Nhập mã lớp" required>
                                    @if ($errors->has('IdClass'))
                                        <span class="text-danger">{{ $errors->first('IdClass') }}</span> <!-- Hiển thị thông báo lỗi -->
                                    @endif
                                </div>
                                <div class="form-group">
