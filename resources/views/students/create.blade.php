                        ...
                        <div class="card-body">
                            <form action="{{ route('students.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('IdClass') is-invalid @enderror" name="IdClass" required>
                                        @foreach ($classrooms as $classroom)
                                            <option value="{{ $classroom->IdClass }}" {{ old('IdClass') == $classroom->IdClass ? 'selected' : '' }}>
                                                {{ $classroom->IdClass }}
                                            </option>
                                        @endforeach
                                    </select>
