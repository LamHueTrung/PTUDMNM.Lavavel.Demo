                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <ul class="list-group list-group-flush">
                                            <li class="list-group-item"><strong>Mã lớp: </strong>{{ $students->first()->IdClass }}</li>
                                            <li class="list-group-item"><strong>Tên lớp: </strong>{{ $students->first()->classroom->NameClass ?? 'Không có thông tin' }}</li>
